...
Following Karpathy’s 10-lecture series "Zero to Hero" that can be found with https://karpathy.ai/, I reconstructed a 124M-parameter GPT-2 decoder entirely by hand and trained it efficiently using FlashAttention, mixed precision, and GPT-3-inspired hyperparameters with gradient accumulation.
...
I imported **CLIP ViT-L/14**, kept both CLIP and the decoder GPT-2 **frozen**, and trained small bridging modules for image captioning.
...
I then trained three architectures on **COCO 2017** (118k train, 5k val, 5 captions/image).
